...
- **높은 정확도** -- F1 96.0% (9,000문장 v15k 골드 테스트셋, ep_norm 정규화), 2025 구어 held-out F1 91.2%
...
> **정확도**: 9,000문장 v15k 골드 테스트셋 F1 96.0% (ep_norm 정규화 기준), 2025 구어 held-out F1 91.2%. 서버 기반 분석기와 다른 설계 목표(경량·브라우저)를 가지므로 단순 수치 비교보다는 사용 환경에 맞는 선택을 권장합니다.
...
**정확도는 어느 정도인가요?**
9,000문장 v15k 골드 테스트셋에서 F1 96.0%(ep_norm 정규화 기준), 2025 구어 held-out 평가셋에서 F1 91.2%입니다.
