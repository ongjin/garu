...
- **높은 정확도** -- F1 95.1% (9,000문장 v15k 골드 테스트셋, ep_norm 정규화), NIKL MP F1 93.7%
...
> **정확도**: 9,000문장 v15k 골드 테스트셋 F1 95.1% (ep_norm 정규화 기준), NIKL MP F1 93.7%. 서버 기반 분석기와 다른 설계 목표(경량·브라우저)를 가지므로 단순 수치 비교보다는 사용 환경에 맞는 선택을 권장합니다.
...
**정확도는 어느 정도인가요?**
9,000문장 v15k 골드 테스트셋에서 F1 95.1%(ep_norm 정규화 기준), 모두의 말뭉치(NIKL MP)에서 F1 93.7%입니다.
