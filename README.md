...
- **높은 정확도** -- F1 93.97% (5,000문장 수동 검증 골드 테스트셋), NIKL MP F1 93.90%
...
> **정확도**: 5,000문장 골드 테스트셋 F1 93.97%, NIKL MP F1 93.90%. 서버 기반 분석기와 다른 설계 목표(경량·브라우저)를 가지므로 단순 수치 비교보다는 사용 환경에 맞는 선택을 권장합니다.
