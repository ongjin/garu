...
> **벤치마크 참고**: 골드 테스트셋은 뉴스·일상·SNS·기술·문학·엣지케이스 5,000문장을 사람이 직접 검증한 데이터입니다. NIKL MP는 표준어 신문 중심 데이터로 Garu의 구어체·신조어 개선이 반영되지 않습니다. v0.2.10부터 나무위키 구어체 코퍼스를 추가해 골드 테스트셋 F1이 향상되었으며, NIKL MP 수치(93.5%)는 이전 버전 대비 소폭 하락했습니다.
