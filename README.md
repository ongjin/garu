...
- **높은 정확도** -- F1 93.6% (9,000문장 v15k 골드 테스트셋, ep_norm 정규화), NIKL MP F1 93.7%
...
> **정확도**: 9,000문장 v15k 골드 테스트셋 F1 93.6% (ep_norm 정규화 기준), NIKL MP F1 93.7%. 서버 기반 분석기와 다른 설계 목표(경량·브라우저)를 가지므로 단순 수치 비교보다는 사용 환경에 맞는 선택을 권장합니다.
